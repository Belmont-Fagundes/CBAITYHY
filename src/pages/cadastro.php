...
<head>
  ...
  <title>Cadastro - PACserver</title>
  <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="bg-gradient-to-br from-blue-600 to-indigo-300 min-h-screen flex items-center justify-center">
  <div class="w-full max-w-md bg-indigo-100 shadow-lg rounded-lg p-8 mx-4 my-12">
    <img src="../images./LOGO_FAVICON.png" alt="Logo PACserver" class="mx-auto w-20 h-22 object-contain mb-4" />
